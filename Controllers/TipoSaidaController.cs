...
namespace ProjetoFinal.Controllers
{
    public class TipoSaidaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TipodeSaida")] TipoSaida tipoSaida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipodeSaida")] TipoSaida tipoSaida)
        {
            if (id != tipoSaida.Id)
            {
                return NotFound();
