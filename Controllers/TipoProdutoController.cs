...
namespace ProjetoFinal.Controllers
{
    public class TipoProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TipodoProduto")] TipoProduto tipoProduto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipodoProduto")] TipoProduto tipoProduto)
        {
