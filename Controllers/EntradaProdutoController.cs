...
namespace ProjetoFinal.Controllers
{
    public class EntradaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,EntradaProdutoData,EntradaProdutoQuantidade")] EntradaProduto entradaProduto)
        {
            if (ModelState.IsValid)
            {
                var produto = await _context.Produto.Where(p => p.Id == entradaProduto.ProdutoId).FirstOrDefaultAsync();
                produto.ProdutoQuantidade = produto.ProdutoQuantidade + entradaProduto.EntradaProdutoQuantidade;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,EntradaProdutoData,EntradaProdutoQuantidade")] EntradaProduto entradaProduto)
        {
