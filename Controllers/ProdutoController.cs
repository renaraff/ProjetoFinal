...
namespace ProjetoFinal.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoProdutoId"] = new SelectList(_context.TipoProduto, "Id", "TipodoProduto");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoNome,ProdutoQuantidade,TipoProdutoId,FornecedorId")] Produto produto)
        {
            ...
            ViewData["TipoProdutoId"] = new SelectList(_context.TipoProduto, "Id", "TipodoProduto", produto.TipoProdutoId);
            return View(produto);
        }
