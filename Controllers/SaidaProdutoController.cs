...
namespace ProjetoFinal.Controllers
{
    public class SaidaProdutoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoSaidaId"] = new SelectList(_context.TipoSaida, "Id", "TipodeSaida");
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,SaidaProdutoData,SaidaProdutoQuantidade,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
            if (ModelState.IsValid)
            {
                var produto = await _context.Produto.Where(p => p.Id == saidaProduto.ProdutoId).FirstOrDefaultAsync();
                produto.ProdutoQuantidade = produto.ProdutoQuantidade - saidaProduto.SaidaProdutoQuantidade;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,SaidaProdutoData,SaidaProdutoQuantidade,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
